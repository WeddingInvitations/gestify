        ...
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between h-16 px-4 border-b border-gray-200">
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <h1 className="text-xl font-bold text-gray-900">Gestify</h1>
              </div>
            </div>
            <button
              onClick={onClose}
          ...
          <div className="px-4 py-4 border-t border-gray-200">
            ...
            <button
              onClick={signOut}
              className="mt-3 w-full text-left px-3 py-2 text-sm text-gray-700 hover:bg-gray-50 rounded-lg transition-colors"
            >
              <div className="flex items-center">
